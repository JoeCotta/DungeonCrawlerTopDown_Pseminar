        ...
        for(int i = 0; i < doors.Length; i++){
            ...
            if(doors[i] == "U"){//erst obberer
                for(int i2 = 0; i2 < templates.rooms.Count; i2++){//für jeden einzelnen Raum dden es gibt
                    ...
                    if(templates.rooms[i2].transform.position.y - thisRoom.transform.position.y == 10 && templates.rooms[i2].transform.position.x == thisRoom.transform.position.x){
                ...
                if(oben == false){
                    Instantiate(door, transform.position + new Vector3(0,4.5f,0), Quaternion.identity);
                    Debug.Log("bug fixed");
                }
            }
            ...
            if(doors[i] == "R"){
                for(int i2 = 0; i2 < templates.rooms.Count; i2++){
                    if(templates.rooms[i2].transform.position.x - thisRoom.transform.position.x == 10 && templates.rooms[i2].transform.position.y == thisRoom.transform.position.y){
                ...
                if(rechts == false){
                    Instantiate(doorvrt, transform.position + new Vector3(4.5f,0,0), Quaternion.identity);
                    Debug.Log("bug fixed");
                }
            }
