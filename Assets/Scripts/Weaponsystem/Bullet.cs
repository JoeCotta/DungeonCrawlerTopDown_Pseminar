...
public class Bullet : MonoBehaviour
{
    ...
    {  
        ...
        if(!gameObject || !other.gameObject || owner == null) return;
        if(other.gameObject.CompareTag("Bullet")&&owner.tag != other.gameObject.GetComponent<Bullet>().owner.tag && other.gameObject != null) Destroy(gameObject); //other condition so that enemy bullets dont delete eachother
    }
}
